            ...
            >
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-xl bg-muted/60 p-3">
                  ...
                  <div className="font-medium">{r.timezone}</div>
                </div>
                <div className="rounded-xl bg-muted/60 p-3">
                  <div className="text-xs text-muted-foreground">Slots</div>
                  <div className="font-medium">{r.availability.length}</div>
                </div>
              </div>
              ...
              <div className="mt-4 rounded-xl border p-3">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm">
                  <span className="font-medium">
                    15m: {formatCents(r.ratePer15Min)}
                  </span>
                  <span className="font-medium">
                    30m: {formatCents(r.ratePer30Min)}
                  </span>
                  <span className="font-medium">
                    60m: {formatCents(r.ratePer60Min)}
                  </span>
                </div>
              </div>
